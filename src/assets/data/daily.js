const dailyList = [
  ...
  {
    date: '2024-05-18',
    msg: `今天我们去高密把家具订了，向前迈进了一大步，装修上的重要节点，喜欢小鱼。<br>临上回青高速前，在路边我吃了个火烧，旁边是麦田，小鱼说喜欢闻麦子的味道（我闻不出来~`,
  },
  {
    date: '2024-05-20',
    msg: `我们破碎了，我失恋了，眼泪哭干了。<br>希望小鱼一切都好。`,
  },
  {
    date: '2024-05-22',
    msg: `我们对彼此“宣泄”了一通，好似把心中的不愉快都发泄了出来。吵吵闹闹恩恩爱爱也可以并肩前行，为什么要压抑自己的天性，释放啊！<br>个人感觉每一次的不愉快，都会使感情趋向于“皮实”，感情更上一层楼，小鱼知道我是这么想的估计会小嘴一憋 o((*^▽^*))o `,
  },
  {
    date: '2024-05-25',
    msg: `柜子装完了，小鱼先去看了，很激动很开心地给我打视频给我看。我不加班了直奔过去，一开门，扑面而来的白~干净整洁，小鱼很开心，连连说像样了，有家的感觉了。小鱼这么好，我要对小鱼好。<br>晚上去城阳吃了“强男烤鳗鱼”，小鱼很喜欢吃。晚上住在了城阳。（那次不愉快后小鱼去城阳她同学闲置的房子那里去住了）`,
  },
  {
    date: '2024-05-26',
    msg: `早上起床天下小雨，我们直奔新家，去收拾打扫。我俩都属于干起活来不抬头那种(●'◡'●)忙活了一天终于把卫生间和柜子打扫出来了，很开心。中午饿了我们点的外卖，和小鱼一起干活，累也不觉得累。一起劳动一起改善居住环境的感觉不要太幸福。`,
    imgList: [
      {
        url: new URL("@/assets/images/2024052601.jpg", import.meta.url).href,
        desc: "我们的丰盛午餐~",
      },
    ]
  },
